...
import haccp from '../assets/certificates/haccp.pdf';
import pv00292189 from '../assets/certificates/pv00292189.pdf';
import iso22000 from '../assets/certificates/iso22000.pdf';
